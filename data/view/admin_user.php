			...
			<div id="adduserdiv" class="tabcontent" style="display:none;">
				...
				<table width="100%">
					...
					<tr>	
						...
						<td>编号:</td>
						<td><input type="text" name="addoutid" class="txt" /></td>
						<td>域登录:</td>
						<td>
							<label><input name="addauthtype" type="radio" value="1" />Yes </label> 
							<label><input name="addauthtype" type="radio" value="0" checked /> No </label> 
						</td>
					</tr>
					<tr>
		...
		<div class="mainbox">
			...
			<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>">
				<table class="opt">
					...
					<tr>
						<td>
							<select name="role" value="<?php echo $user['role'];?>">
					...
					<tr>
						<td>
							<input type="text" name="outid" value="<?php echo $user['outid'];?>" class="txt" />
						</td>
					</tr>
						...
						<td>
							<label>
								<?php if($user['auth_type'] == '1') { ?>
									<input name="autytype" type="radio" value="1" checked />
								<?php } else { ?>
									<input name="autytype" type="radio" value="1" />
								<?php } ?>								
								Yes 
							</label> 
							<label>
								<?php if($user['auth_type'] == '0') { ?>
									<input name="autytype" type="radio" value="0" checked />
								<?php } else { ?>
									<input name="autytype" type="radio" value="0" />
								<?php } ?>
							No 
							</label> 
